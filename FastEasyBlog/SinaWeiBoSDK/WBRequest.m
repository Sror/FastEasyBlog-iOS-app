    ...
    else if (postDataType == kWBRequestPostDataTypeMultipart)
    {
		...
		if ([dataDictionary count] > 0) 
		{
			for (id key in dataDictionary) 
			{
				...
				{
					NSData* imageData = [NSData dataWithContentsOfFile:PUBLISH_IMAGEPATH_SINAWEIBO];
					[WBRequest appendUTF8Body:body dataString:[NSString stringWithFormat:@"Content-Disposition: form-data; name=\"%@\"; filename=\"file.jpg\"\r\n", key]];
					[WBRequest appendUTF8Body:body dataString:[NSString stringWithString:@"Content-Type: image/jpg\r\nContent-Transfer-Encoding: binary\r\n\r\n"]];
