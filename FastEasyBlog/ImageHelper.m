...
+ (CGRect) frameSize: (CGSize)thisSize
              inSize: (CGSize) aSize
{
...
+ (UIImage *) roundedBacksplashOfSize: (CGSize)size
                             andColor:(UIColor *) color
                         withRounding: (CGFloat) rounding
                             andInset: (CGFloat) inset
{
