...
- (NSObject *)markerEncountered:(NSString *)marker
                  withArguments:(NSArray *)args
                        inRange:(NSRange)markerRange 
...
- (BOOL)currentBlock:(NSDictionary *)blockInfo
   matchesTopOfStack:(NSMutableArray *)stack
{
...
- (BOOL)argIsNumeric:(NSString *)arg
            intValue:(int *)val
      checkVariables:(BOOL)checkVars
{
	BOOL numeric = NO;
	int value = 0;
